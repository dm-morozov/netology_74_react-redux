...
- Главный экран с формой.
  ![Главный экран](./images/main-screen-of-the-application.png)

- Главный экран с формой и списком.
  ![Главный экран с списком](./images/main-screen-with-list.png)

- Режим редактирования.
  ![Режим редактирования](./images/editing-mode.png)

- Поиск с подсветкой.
  ![Поиск с подсветкой](./images/search-with-highlight.png)
